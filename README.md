<div align="center">
  ...
  [![下载 Windows 客户端](https://img.shields.io/badge/Windows-下载桌面端-2563EB?style=for-the-badge)](https://prod-lab-1321001571.cos.ap-guangzhou.myqcloud.com/releases/cine-sleuth/windows/x64/CineSleuth-2.0.8-Windows-x64-Setup.exe)
...
**[下载 Windows 客户端 · 2.0.8（x64）](https://prod-lab-1321001571.cos.ap-guangzhou.myqcloud.com/releases/cine-sleuth/windows/x64/CineSleuth-2.0.8-Windows-x64-Setup.exe)**
...
> Windows x64 安装包尚未代码签名，Windows 可能显示发布者验证提示。请仅从上述官方 COS 地址下载；桌面版与 Skill 版本号独立。桌面发布标签为 `desktop-v2.0.8`，功能范围见 [桌面说明](desktop/README.md)。

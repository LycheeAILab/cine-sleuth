...
const methods=['state','login','logout','devices','select','start','resume','pause','history','results','export','modelStatus','modelSave','modelClear','modelList','summaryRead','summarize','summaryExport'];

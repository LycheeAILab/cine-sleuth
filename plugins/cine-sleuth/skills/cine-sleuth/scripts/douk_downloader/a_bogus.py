...
# Derived from JoeanAmier/TikTokDownloader 5.8 beta (src/encrypt/aBogus.py).
...
class ABogus:
    ...
    def sm3_to_array(cls, data: str | list) -> list[int]:
        ...
        # Prefer OpenSSL's SM3 implementation. Some macOS/Python builds omit it, so retain the
        # small gmssl compatibility path installed by requirements.txt.
        try:
